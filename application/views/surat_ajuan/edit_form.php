<main>
	<div class="container-fluid">
		...
		<ol class="breadcrumb mb-4">
			<li class="breadcrumb-item"><a href="<?php echo site_url('surat_ajuan') ?>">Surat Masuk</a></li>
			...
			<div class="card-body">
				<form action="<?php echo site_url('surat_ajuan/edit') ?>" method="post" enctype="multipart/form-data" >
					...
					<div class="mb-3">
						...
						<input class="form-control" type="text" name="surat_from" value="<?=$surat->surat_from;?>" placeholder="SURAT DARI" disabled required />
					</div>
					<div class="mb-3">
					...
					<div class="mb-3">
						...
						<input class="form-control" type="datetime-local" name="tgl_terima" value="<?=$surat->tgl_terima;?>" placeholder="TANGGAL TERIMA SURAT" disabled required />
					</div>
					<div class="mb-3">
						...
						<button class="btn btn-primary" type="submit"><i class="fa fa-plus"></i> Save Data</button>
					</form>
				</div>
			</div>
